	...
	var Memory = {
		...
		buildHTML: function(){
			...
			this.$cards.each(function(k, v){
				...
				<div class="front"><img src01="'+ v.img +'"\
				alt="'+ v.name +'" /></div>\
				<div class="back"><img src01="https://images.unsplash.com/photo-1576836165612-8bc9b07e7778?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1587&q=80"\
				alt="Codepen" /></div></div>\
				</div>';
			});
